...
pub struct Instance {
    ...
    #[serde(alias = "total_play_time")]
    pub total_play_time: Option<u64>,
    #[serde(alias = "longest_session")]
...
#[command]
pub async fn update_instance(id: String, name: Option<String>, version: Option<String>, versions: Option<Vec<String>>, mod_loader: Option<String>, mod_loader_version: Option<String>, icon: Option<String>, background_image: Option<String>, last_played: Option<u64>, total_play_time: Option<u64>, longest_session: Option<u64>, session_count: Option<u64>, is_favorite: Option<bool>) -> Result<Instance, String> {
    ...
    if let Some(tpt) = total_play_time { instance.total_play_time = Some(tpt); }
    if let Some(ls) = longest_session { instance.longest_session = Some(ls); }
    if let Some(sc) = session_count { instance.session_count = Some(sc); }
