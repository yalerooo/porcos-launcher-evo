...
import { Home, Box, Settings, Terminal, LogOut, Minus, X, Puzzle } from 'lucide-react';
  ...
  return (
    <div className="launcher-container flex h-screen overflow-hidden bg-[var(--bg-secondary)]">
      ...
      <div className="flex-1 flex flex-col h-full relative min-w-0 bg-[var(--bg-secondary)]">
          ...
          <div className="h-14 w-full flex items-center justify-end select-none bg-[var(--bg-secondary)]" data-tauri-drag-region>
            <button 
          ...
          {/* Main Content */}
          <main className="content-area flex-1 overflow-hidden bg-[var(--bg-primary)] relative z-10 rounded-tl-[30px]">
